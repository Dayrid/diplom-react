...
function ProductCardPanel({ id, product }: FormatProps) {
    ...
    return (
        <Flex align={'flex-start'} gap={'xl'}>
            <ProductCardView product_name={product.name} product_article={product.article} media={product.mapping[id].media} image={product.mapping[id].image}></ProductCardView>
            <Stack w={"100%"}>
                <h3>Категория:</h3>
                <Text>12312</Text>
                <Divider></Divider>
